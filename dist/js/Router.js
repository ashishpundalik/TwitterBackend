...
module.exports = function () {
	...
	var init = function init(express, definedRoutes) {
	...
	var configureUserTweetsRoute = function configureUserTweetsRoute() {
	...
	var configureMyTweetsRoute = function configureMyTweetsRoute() {
	...
	var configureSearchTweets = function configureSearchTweets() {
		console.log("Configuring route: " + routes.myTweets);
